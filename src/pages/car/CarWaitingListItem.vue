<template lang="">
    ...
    <div class="modal-wrap" v-show="rejectModalCheck" >
        <div class="modal-container">
            <button class="cancel" @click="openRejectModal"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-x-circle" viewBox="0 0 16 16">
    ...
    <div class="modal-wrap" v-show="approveModalCheck" >
        <div class="modal-container">
            <button class="cancel" @click="openApproveModal"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-x-circle" viewBox="0 0 16 16">
                <path d="M8 15A7 7 0 1 1 8 1a7 7 0 0 1 0 14zm0 1A8 8 0 1 0 8 0a8 8 0 0 0 0 16z"/>
                <path d="M4.646 4.646a.5.5 0 0 1 .708 0L8 7.293l2.646-2.647a.5.5 0 0 1 .708.708L8.707 8l2.647 2.646a.5.5 0 0 1-.708.708L8 8.707l-2.646 2.647a.5.5 0 0 1-.708-.708L7.293 8 4.646 5.354a.5.5 0 0 1 0-.708z"/>
                </svg></button>
            <div class="approvedetail">
                <label>신청자</label> <span style="font-size: 15px; margin-left:15px;">{{w.member.name}}</span><br><br>
                <label>부서명</label> <span style="font-size: 15px; margin-left:15px;">{{w.member.department.name}}</span><br><br>
                <label>차량번호</label> <span style="font-size: 15px;">{{w.car.carNo}}</span><br><br>
                <label>차종</label> <span style="font-size: 15px; margin-left:30px;">{{w.car.carType}}</span><br><br>
                <label>대여기간</label> <span style="font-size: 15px;">{{w.startDate}} ~ {{w.endDate}}</span><br><br>
                <label>대여목적</label> <span style="font-size: 15px;">{{w.purpose}}</span>
                <div class="modal-btn">
